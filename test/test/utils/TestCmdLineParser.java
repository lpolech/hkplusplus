...
public class TestCmdLineParser {
	...
	public void testCmdLineParser() {
		String[] args = new String[] { "-i", "test.csv", "-lgmm", "-s", "2", "-v", "-o", "out", "-k", "4", "-n", "1",
				"-r", "1", "-e", "10", "-l", "0", "-c", "-dm", "-gi", "900", "-w", "2147483600", "-in", };
		...
		args = new String[] { "-i", "test.csv", "-gmm", "-s", "2", "-v", "-o", "out", "-k", "4", "-n", "2", "-r", "3",
				"-e", "10", "-l", "0", "-c", "-dm", "-gi", "900", "-w", "2147483600", "-in", "-ds", "-scac",
//				"-sccs",
//				"-scrs",
				"-rf", "0.5", "-cf", "0.88", "-re" };
		parser.parse(args);
